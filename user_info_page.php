                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    if (!empty($acc)) {
                        ...
                        if ($rows = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<div class="" style="background: url(uploads/$img_name) no-repeat center/cover;">';
                        } else {
                            echo '<div class=""></div>';
   ...
   <a id="link" class="nav-link" href="http://localhost:8080/mid-web/register_page.php">註冊</a>
      ';
        ...
        <div class="container-fluid p-0">
            <div class="row m-0 p-0" style="height:100%; margin:0;">
                <div class="col-12 p-5">
                    <div style="display:flex">
                        <h1 style="margin-right: 5px;" id="titlefont">個人資料</h1>
                    </div>
                    <hr>
                    <div class="infoWrapper">
                        <div class="myContainer">
                            ...
                            ?>
                            <a href="http://localhost:8080/mid-web/croppie_page.php">
                                <div class="editImg">
                                    <input id="uploadImg">
                        ...
                        <div class="infoContent">
                            <form>
                                <div class="mb-3">
                                    ...
                                    <div style="display: flex;">
                                        <input type="text" name="name" value="<?php echo $name; ?>" class="form-control" id="exampleFormControlInput1" disabled>
                                        <a style="color:black; margin-left : 15px;" href="http://localhost:8080/mid-web/user_edit_name_page.php">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div style="display: flex;">
                                        <input type="password" name="pwd" class="form-control" id="exampleFormControlInput1" placeholder="••••••••" disabled>
                                        <a style="color:black; margin-left : 15px;" href="http://localhost:8080/mid-web/user_edit_pwd_page.php">
                                            <h4><i class="bi bi-pencil-square"></i></h4>
                                        </a>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" value="<?php echo $email; ?>" class="form-control" id="exampleFormControlInput1" value="name@example.com" disabled>
                                </div>
