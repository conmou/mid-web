...
<body>
    ...
    <div class="wrapper" style="height:auto;">
        <div style="width: 880px;">
            <h1 id="titlefont" style="padding-top:4%; padding-left:4%;">文章審核<a data-bs-toggle="tooltip" title="留言審核" href="manager_page1.php"><i class="bi bi-toggle-off ml-3" style="font-size: 40px; color:#df8200;"></i></a>
            </h1>
            <hr>
        </div>
        <?php
        ...
        $todos = $conn->query("SELECT article.*,member.img_name FROM article,member WHERE member.m_Id=article.m_Id ORDER BY post_time DESC");
                ...
                <div class="col-8 pl-5 pr-5 m-0">
                    ...
                    ?>
                            <div class="p-3 rounded" id="showforum" onclick="location.href='forumques.php?msg=edit&id=<?php echo $todo['arti_Id']; ?>';" style="background-color: rgb(239, 239, 239);">
                                <div class="d-flex">
                                    <p class="muted "><a class="shake" data-bs-toggle="tooltip" title="通過審核" href="cover_article.php?id=<?php echo $todo['arti_Id']; ?>&action=pass" id="passBtn"><i class="bi bi-shield-check" style="font-size: 35px ; color:green;"></i></a></p>
                                    <p class="muted "><a class="shake" data-bs-toggle="tooltip" title="隱藏文章" href="cover_article.php?id=<?php echo $todo['arti_Id']; ?>&action=cover" id="coverBtn"><i class="bi bi-x-circle" style="font-size: 35px ; color:#D7443E;"></i></a></p>
