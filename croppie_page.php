...
<body>
    ...
    <div class="container">
        <div class="card" style="max-height: 500px; width :1000px; margin-top: 200px;">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6" style="padding:8%;">
                        <div class="choose" style="margin-bottom: 8%;">
                            <strong style="font-size:x-large">選擇頭貼檔案: </strong>
                            <input type="file" id="image">
                        </div>
                        <div class="submit">
                            <button class="btn btn-success btn-block btn-upload-image" style="margin-top: 2%;">確認上傳</button>
                        </div>
                    </div>
                </div>
            </div>
