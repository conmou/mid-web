                        ...
                        <div class="infoContent">
                            <form action="user_info_update.php" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="新的暱稱">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">帳號</label>
                                    <input type="text" placeholder="<?php echo $acc; ?>" class="form-control" id="exampleFormControlInput1" disabled>
                                </div>
                                <div class="mb-3">
